 ...
 */
        switch(home->param->materialType) {
			...
			/* iryu / 2013.10.23
			 * for ANISOTROPIC LOADING IN FCC  */
			#if _ANISO_DEBUG
				printf("In FindPreciseGlidePlane, enforceGlidePlane in FCC\n");
			#endif
			real8 eiEj[3][3];
			...
			BurgVec[0] = eiEj[0][0]*burgVec[0] + eiEj[0][1]*burgVec[1] + eiEj[0][2]*burgVec[2];
			BurgVec[1] = eiEj[1][0]*burgVec[0] + eiEj[1][1]*burgVec[1] + eiEj[1][2]*burgVec[2];
			BurgVec[2] = eiEj[2][0]*burgVec[0] + eiEj[2][1]*burgVec[1] + eiEj[2][2]*burgVec[2];
			
			Dir[0] = eiEj[0][0]*dir[0] + eiEj[0][1]*dir[1] + eiEj[0][2]*dir[2];
			Dir[1] = eiEj[1][0]*dir[0] + eiEj[1][1]*dir[1] + eiEj[1][2]*dir[2];
			Dir[2] = eiEj[2][0]*dir[0] + eiEj[2][1]*dir[1] + eiEj[2][2]*dir[2];
			
                        FindFCCGlidePlane(BurgVec, Dir, GlidePlane);

			/* transformation from (001) coord to the rotated coord */
			glidePlane[0] = eiEj[0][0]*GlidePlane[0] + eiEj[1][0]*GlidePlane[1] + eiEj[2][0]*GlidePlane[2];
			glidePlane[1] = eiEj[0][1]*GlidePlane[0] + eiEj[1][1]*GlidePlane[1] + eiEj[2][1]*GlidePlane[2];
			glidePlane[2] = eiEj[0][2]*GlidePlane[0] + eiEj[1][2]*GlidePlane[1] + eiEj[2][2]*GlidePlane[2];
			#if _ANISO_DEBUG
			printf("b= [%e %e %e], xi=[%e %e %e] glide=[%e %e %e]\n",
				burgVec[0],burgVec[1],burgVec[2],dir[0], dir[1], dir[2],
					glidePlane[0], glidePlane[0], glidePlane[0]);
			printf("B= [%e %e %e], Xi=[%e %e %e] Glide=[%e %e %e]\n",
				BurgVec[0],BurgVec[1],BurgVec[2],Dir[0], Dir[1], Dir[2],
					GlidePlane[0], GlidePlane[0], GlidePlane[0]);
			#endif
