...
//iryu
#ifndef _CYLINDER
// When start with dislocation segments which is located outside cylinder, 
// it would show the message too much.  
...
#ifdef _CYLINDER
	cellIndex[X]=cellIndexX;
	cellIndex[Y]=cellIndexY;
	cellIndex[Z]=cellIndexZ;
#endif
