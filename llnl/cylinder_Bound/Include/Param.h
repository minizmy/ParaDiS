 ...
 */
        ...
        real8 gamma;  /* stackingfault energy (J/burgmag), multiplication factor for gamman */
#endif
...
#ifdef _CYLINDER/*iryu/2011.02.02 -- Add mobility for surface nodes */
        real8 MobSurfaceScale;

	real8 cyl_radius;
	int   cyl_nq,cyl_nz;        /* Number of points in the Fourier decomposition    */
                        	    /* of stress                                        */ 
	real8 cyl_VSlength;         /* Length of the Virtual Segment. It should be a    */
	                            /* function of the size of the segment.             */
				    /* Maybe the average size of a segment * 100        */
	real8 cyl_delSegLength;     /* Counts deleted segments during TF remesh         */
	int NimgPBC;		    /*Number of periodic image in Z direction for AllSegmentStress*/		
	int Loading_Direction;	    /*Loading direction= Postive : tension/twist (2014.06.25/iryu)  
                                                         Negative: compression / untwist*/		
	real8 threshold;	    /*Threshold stress for Peierls barrier (2012.12.20/iryu) */		 

	real8 ANISO_110;	    /* For anisotropic loading (101) (111) */
	real8 ANISO_111;

//#ifdef _TORSION 
	real8 AppliedTheta;         // angle of twist in degree 
	real8 ThetaRate;	    // rate of angle of twist [degree/sec]
	real8 pTheta;         
	real8 DelpTheta;         
//	real8 dot_SurfStrain_tol;
	real8 dot_dpTheta_tol;
	real8 dot_appliedTheta;
	int   Zboundary;	    /* Zboundary = 0 (default) : Fix displacement in Z direciton (2015.05.08/iryu)  
                                                   1             Fix stress in z direction                      */		
//	real8 dot_Torque;
//#endif
...
//#ifdef _BOUNDARY
	real8 IntBoundary[4]; // Internal Boundary Planes
//#endif	
...
//#ifdef _NUCLEATION
	...
	real8 NucSTRESSCon;	    // Average value of Stress concentration factor for free surface
	real8 NucSTRESSConGB;   // Average value of Stress concentration factor for GB nucleation
