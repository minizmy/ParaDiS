 ...
 */
		...
		ComputeTF1SegSigbRem(home, thinfilm, node, 
				     nbr, armID1, armID2);
	      }
	    }
			  ...
			  int armID1, int armID2)
{
...
#ifdef _TFIMGSTRESS
      DispStress(thinfilm,r,totRemSig);
#endif  
  ...
  AllYoffeStress(home, thinfilm, r[0], r[1], r[2], YoffeStress);
 ...
 */
		    ...
		    ComputeVirtualForces(home, thinfilm,
			  ...
			  real8 *f3, real8 *f4)
{
	...
	LenVirtualSeg = thinfilm->LenVirtualSeg;
