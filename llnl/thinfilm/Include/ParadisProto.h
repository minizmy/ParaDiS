...
#ifdef _THINFILM
void TrapezoidIntegrator(Home_t *home, ThinFilm_t *thinfilm);
#else
...
#ifdef _THINFILM
void CrossSlip(Home_t *home, ThinFilm_t *thinfilm);
void CrossSlipBCC(Home_t *home, ThinFilm_t *thinfilm);
void CrossSlipFCC(Home_t *home, ThinFilm_t *thinfilm);
#else
...
#ifdef _THINFILM
void DeltaPlasticStrain_BCC(Home_t *home, ThinFilm_t *thinfilm);
#else
void DeltaPlasticStrain_BCC(Home_t *home);
#endif

#ifdef _THINFILM
void DeltaPlasticStrain_FCC(Home_t *home, ThinFilm_t *thinfilm);
#else
...
#ifdef _THINFILM
void ForwardEulerIntegrator(Home_t *home, ThinFilm_t *thinfilm);
#else
...
#ifdef  _THINFILM
void Remesh(Home_t *home, ThinFilm_t *thinfilm);
#else
