...
#ifdef _THINFILM
void PartialForces(Home_t *home, ThinFilm_t *thinfilm);
#else
...
#ifdef _THINFILM
void ReevaluateForces(Home_t *home, ThinFilm_t *thinfilm);
#else
...
#ifdef _THINFILM
void SetOneNodeForce(Home_t *home, ThinFilm_t *thinfilm, Node_t *node1);
#else
