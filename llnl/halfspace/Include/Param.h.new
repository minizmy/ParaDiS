...
#ifdef _HALFSPACE 
  real8 hs_Lzinf;
  int hs_nx,hs_ny;      /* Number of points in the Fourier decomposition */
                        /* of stress                                     */
  int hs_numimages;     /* Number of periodic images taken in the x and y*/
                        /* direction                                     */

  real8 hs_VSlength;        /* Length of the Virtual Segment. It should be a    */
                            /* function of the size of the segment.             */
			    /* Maybe the average size of a segment * 100        */
  real8 hs_Mx;              /* Bending moments                                  */
  real8 hs_Bend_theta;      /* Angle between the bending axis and x-ais         */

  real8 HS_delSegLength;    /* Counts deleted segments during HS remesh         */
#endif
