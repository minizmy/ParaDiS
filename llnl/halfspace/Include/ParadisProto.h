...
#ifdef _HALFSPACE
void TrapezoidIntegrator(Home_t *home, HalfSpace_t *halfspace);
#else
...
#ifdef _HALFSPACE
void CrossSlip(Home_t *home, HalfSpace_t *halfspace);
void CrossSlipBCC(Home_t *home, HalfSpace_t *halfspace);
void CrossSlipFCC(Home_t *home, HalfSpace_t *halfspace);
#else
...
#ifdef _HALFSPACE
void DeltaPlasticStrain_BCC(Home_t *home, HalfSpace_t *halfspace);
#else
void DeltaPlasticStrain_BCC(Home_t *home);
#endif

#ifdef _HALFSPACE
void DeltaPlasticStrain_FCC(Home_t *home, HalfSpace_t *halfspace);
#else
...
#ifdef _HALFSPACE
void ForwardEulerIntegrator(Home_t *home, HalfSpace_t *halfspace);
#else
...
#ifdef  _HALFSPACE
void Remesh(Home_t *home, HalfSpace_t *halfspace);
#else
