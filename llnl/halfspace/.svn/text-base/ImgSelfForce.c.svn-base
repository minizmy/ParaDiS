...
void ImgSelfForce(Home_t *home,HalfSpace_t *halfspace) 
{
    int i,j,k,l;
    Node_t *nodea, *nodeb, *nbra, *nbrb;
    Param_t *param;
    int seg12Local,seg34Local,armID12,armID21,armID34,armID43,arma,armb;
    double a,MU,NU,HSLx,HSLy,x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4,dx,dy,dz;
    ...
    int numimages = halfspace->numimages;
